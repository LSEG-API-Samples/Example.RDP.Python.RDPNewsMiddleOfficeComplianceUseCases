...
#	 	-h		<create subscription to news headlines>
#		-s		<create subscription to news stories>
#		-r 		<retrieve, print and remove all queued message per specified subscription, default is the last stored>
#
#		in order to drain the queue every 24 hrs, run with option -r using task scheduler
# #=============================================================================
...
#==============================================
	if len(sys.argv) > 1:
		...
		print("  -r endpointPerSubscription cryptographyKey     <retrieve&remove queed message per subscriptionId>")
